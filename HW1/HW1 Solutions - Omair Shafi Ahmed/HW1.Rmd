...
EPA_Uranium = EPA_Uranium %>% group_by(`Which EPA Section is This From?`
                                        ,`US EPA Risk Rating`) %>% 
                                 summarize(`Mean Uranium` = mean(mean(`Amount of Uranium234`)
                                                          ,mean(`Amount of Uranium235`)
                                                          ,mean(`Amount of Uranium238`), na.rm=TRUE))

ggplot(data=EPA_Uranium) + geom_col(aes(x=EPA_Uranium$'US EPA Risk Rating', y=EPA_Uranium$'Mean Uranium')) + facet_wrap(~ EPA_Uranium$'Which EPA Section is This From?') + xlab('US EPA Risk Rating') + ylab('Avg Uranium')
```
...
ggplot(data=EPA_Uranium) + geom_col(aes(x=EPA_Uranium$'US EPA Risk Rating', y=EPA_Uranium$'Mean Uranium', fill = EPA_Uranium$'Which EPA Section is This From?'), position = 'dodge') + xlab('US EPA Risk Rating') + ylab('Avg Uranium')
